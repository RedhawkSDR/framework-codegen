...
setup(name='redhawk-codegen',
      ...
      packages=['redhawk',
                ...
                'redhawk.codegen.jinja.project.softPackageDependency.cpp',
                'redhawk.codegen.jinja.project.softPackageDependency.existing',
      ...
      package_data={'redhawk.codegen.jinja.common':['templates/*'],
                    ...
                    'redhawk.codegen.jinja.project.softPackageDependency.cpp':['templates/*'],
                    'redhawk.codegen.jinja.project.softPackageDependency.existing':['templates/*'],
