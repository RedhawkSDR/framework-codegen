...
/*{% if struct.cpptype == "frontend_tuner_status_struct_struct" %}*/
struct ${struct.cpptype} : frontend::default_frontend_tuner_status_struct_struct{
    ${struct.cpptype} () : default_frontend_tuner_status_struct_struct()
    {
/*{%- for field in struct.fields if field.cppvalue %}*/
/*{%     if field.cppname not in struct.basefields %}*/ 
...
/*{% else %}*/
/*{%     if struct.cpptype != "connection_descriptor_struct" %}*/
