...
from mapping import DependencyExistingProjectMapper
...
class DependencyExistingProjectGenerator(CppCodeGenerator):
    ...
    def templates(self, project):
        return [
            ...
            PkgconfigTemplate('package.pc'),
            ShellTemplate('base/build.sh'),
            ShellTemplate('common/reconf')
            ]

    def componentMapper(self):
        return DependencyExistingProjectMapper()
