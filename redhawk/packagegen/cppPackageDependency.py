...
class CppPackageDependency(SoftPackage):
    ...
    def __init__(
            ...
            variant = ""):
        self.type = type     
        self.arch = ['i686','x86_64','armv7l']
        self.useArch = False
        self.proc = ""        
        if implementation:
            if implementation == 'x86' or implementation == 'x86_64' or implementation == 'armv7l':
                self.proc = implementation               
                implementation = "cpp_"+implementation
            #elif implementation == 'all':
            #    self.useArch = True        
        else:
            implementation = "cpp"
        ...
        self._createWavedevContent(generator="project.softPackageDependency.cpp")
    ...
    def _setImplementation(self):
        ...
        implementation.add_os(value=os)
        if self.proc:
            implementation.add_processor(spd.processor(name=self.proc))
        else:        
            implementation.add_processor(spd.processor(name="x86"))
